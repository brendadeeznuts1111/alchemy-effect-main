...
const Ac = resolveAt(`identifier`),
  jc = memoize((e) => {
    let t = Ac(e);
    return typeof t == `string` ? t : e.getExpected(jc);
  });
function set(e, t, n) {
  return (
    t === `__proto__`
...
const escape = (e) => e.replace(/[/\\^$*+?.()|[\]{}]/g, `\\$&`),
  ...
  Pc = `~effect/data/Redacted`,
  isRedacted = (e) => p(e, Pc),
  Fc = __name((e, t) => {
    let n = Object.create(Ic);
    return (t?.label && (n.label = t.label), Mc.set(n, e), n);
  }, `make`),
  Ic = {
    [Pc]: { _A: (e) => e },
    label: void 0,
    ...
    [h]() {
      return hash(Mc.get(this));
    },
    [v](e) {
      return isRedacted(e) && equals$2(Mc.get(this), Mc.get(e));
    },
  },
  Lc = Nc,
  Rc = `~effect/SchemaIssue/Issue`;
function isIssue(e) {
  return p(e, Rc);
}
var Base$1 = class {
...
const defaultLeafHook = (e) => {
    ...
    switch (e._tag) {
      case `InvalidType`:
        return getExpectedMessage(jc(e.ast), formatOption(e.actual));
      case `InvalidValue`:
      ...
      return e.issues.length === 0
        ? i === void 0
          ? [
              {
                path: t,
                message: getExpectedMessage(jc(e.ast), format$1(e.actual)),
              },
            ]
          : [{ path: t, message: i }]
...
var Bc = class Getter extends s {
  run;
  constructor(e) {
    (super(), (this.run = e));
  }
  map(e) {
    return new Getter((t, n) => this.run(t, n).pipe(Tc(St(e))));
  }
  compose(e) {
    return isPassthrough(this)
      ...
      : isPassthrough(e)
        ? this
        : new Getter((t, n) => this.run(t, n).pipe(Dc((t) => e.run(t, n))));
  }
};
const Vc = new Bc(q);
...
function onSome(e) {
  return new Bc((t, n) => (k(t) ? ls : e(t.value, n)));
}
...
const Hc = `~effect/SchemaTransformation/Transformation`;
...
const Wc = new Z(passthrough$1(), passthrough$1());
function passthrough() {
  return Wc;
}
const Gc = new Z(Number$3(), String$3()),
...
const Kc = makeGuard(`Declaration`),
  qc = makeGuard(`Never`),
  Jc = makeGuard(`Literal`),
  Yc = makeGuard(`UniqueSymbol`),
  Xc = makeGuard(`Arrays`),
  Zc = makeGuard(`Objects`),
  Qc = makeGuard(`Union`);
var Link = class {
  to;
  transformation;
...
var Base = class {
  ...
  tl = class Declaration extends Base {
    _tag = `Declaration`;
    typeParameters;
    run;
    ...
    getParser() {
      ...
      return (t, n) => (k(t) ? ls : Tc(e(t.value, this, n), O));
    }
    recur(e) {
...
var Undefined$1 = class extends Base {
  ...
  toCodecJson() {
    return replaceEncoding(this, [rl]);
  }
  getExpected() {
    return `undefined`;
  }
...
const cl = new Number$2();
var ll = class Arrays extends Base {
  _tag = `Arrays`;
  isMutable;
  elements;
  rest;
...
const resolveConcurrency = (e) => (
  ...
  dl = `[+-]?\\d*\\.?\\d+(?:[Ee][+-]?\\d+)?`,
  fl = new globalThis.RegExp(`(?:${dl}|Infinity|-Infinity|NaN)`);
function getIndexSignatureKeys(e, t) {
  ...
  switch (n._tag) {
    ...
    case `Number`:
      return Object.keys(e).filter((e) => fl.test(e));
    case `Union`:
  ...
  ml = class Objects extends Base {
    ...
    getParser(e) {
      ...
      let o =
        a > 0
          ? iterateEager()({
              onItem: kc(function* (n, [r, i]) {
                let a = e(Ol(i.parameter))(O(r), n.options),
...
function union(e, t, n) {
  return new _l(e.map(getAST), t, void 0, n);
}
  ...
  switch (e._tag) {
    ...
    case `Objects`:
      return e.propertySignatures.flatMap((e) => {
        let t = e.type;
        if (!isOptional(t)) {
          if (Jc(t)) return [{ key: e.name, literal: t.literal }];
          if (Yc(t)) return [{ key: e.name, literal: t.symbol }];
        }
        return [];
      });
    case `Arrays`:
      return e.elements.flatMap((e, t) =>
        Jc(e) && !isOptional(e) ? [{ key: t, literal: e.literal }] : [],
      );
    case `Suspend`:
...
var _l = class Union$1 extends Base {
  static {
    __name(this, `Union`);
  }
  _tag = `Union`;
  ...
  getParser(e) {
    ...
    return (n, r) => {
      ...
      let i = n.value,
        ...
        s = vl(o, a, resolveConcurrency(r?.concurrency));
      return s
...
var xl = class Filter extends s {
  ...
  Sl = class FilterGroup extends s {
    _tag = `FilterGroup`;
    checks;
    annotations;
...
function makeFilter$1(e, t, n = !1) {
  return new xl((t, n, r) => make$7(t, n, e(t, n, r)), t, n);
}
...
const Cl = applyToLastLink(optionalKey$1);
...
function withConstructorDefault$1(e, t) {
  let n = [new Link(ol, new Z(withDefault(t), passthrough$1()))];
  return replaceContext(
    e,
    e.context
      ? new Context(
...
const wl = memoize((e) => {
    if (e.encoding) return wl(replaceEncoding(e, void 0));
    let t = e;
    return t.recur?.(wl) ?? t;
  }),
  Tl = memoize((e) => wl(El(e)));
function flipEncoding(e, t) {
  let n = t,
    r = n.length,
    i = n[r - 1],
    a = [new Link(El(replaceEncoding(e, void 0)), n[0].transformation.flip())];
  for (let e = 1; e < r; e++)
    a.unshift(new Link(El(n[e - 1].to), n[e].transformation.flip()));
  let o = El(i.to);
  return o.encoding
...
const Ol = toCodec((e) => {
  ...
  kl = `[\\s\\S]*?`,
  Al = new globalThis.RegExp(`^${dl}$`);
function isStringFinite(e) {
  return isPattern$1(Al, {
    expected: `a string representing a finite number`,
    meta: { _tag: `isStringFinite`, regExp: Al },
    ...e,
  });
}
const jl = appendChecks(sl, [isStringFinite()]),
  Ml = new Link(jl, Gc),
  Nl = new Link(new _l([jl, yl], `anyOf`), Gc),
  Pl = `-?\\d+`;
`${Pl}`;
...
const Il = new Link(
    new tl(
      ...
      {
        expected: `StringTree`,
        toCodecStringTree: () => new Link(ol, passthrough()),
      },
    ),
    passthrough(),
  ),
    ...
    switch (e._tag) {
      ...
      case `Arrays`:
        return e.recur((e) => {
          ...
          return t ? replaceEncoding(Ll(e), t) : Ll(e);
        });
      case `Suspend`:
        return e.recur(Ll);
      default:
...
function makeOption(e) {
  let t = makeEffect(e);
  return (e, n) => uo(bc(t(e, n)));
}
function make$5(e) {
  let t = makeEffect(e);
  return (e, n) => yc(Ec(t(e, n), (e) => Error(e.toString(), { cause: e })));
}
__name(make$5, `make`);
function _is(e) {
  let t = asExit(run(wl(e)));
  return (e) => co(t(e, $c));
}
...
const Rl = memoize((e) => {
    ...
    let r = Xc(e) || Zc(e) || (Kc(e) && e.typeParameters.length > 0);
    return (i, a) => {
      n && (a = { ...a, ...n });
      let o = e.encoding,
        s;
      if (o) {
        ...
        s = Ec(s, (t) => new Encoding(e, i, t));
      }
      t ??= e.getParser(Rl);
      let c = s ? Dc(s, (e) => t(e, a)) : t(i, a);
...
__name(make$4, `make`);
const Vl = `~effect/Schema/SchemaError`;
...
function makeReorder(e) {
  return (t) => {
    let n = new Map();
    for (let e = 0; e < t.length; e++) n.set(Tl(t[e]), e);
    let r = [...t].sort((t, r) => {
      ((t = Tl(t)), (r = Tl(r)));
      let i = e(t),
        a = e(r);
...
function declareConstructor() {
  return (e, t, n) => Q(new tl(e.map(getAST), (e) => t(e.map((e) => Q(e))), n));
}
...
const Q = make$4;
function isSchema(e) {
  return p(e, Hl) && e[Hl] === Hl;
}
const Ul = lambda((e) => Q(optionalKey$1(e.ast), { schema: e })),
  Wl = lambda((e) => Ul(Ql(e)));
function Literal(e) {
...
function Record(e, t, n) {
  let r =
    n?.keyValueCombiner?.decode || n?.keyValueCombiner?.encode
      ? new pl(n.keyValueCombiner.decode, n.keyValueCombiner.encode)
      : void 0;
...
const Xl = lambda((e) => Q(new ll(!1, [], [e.ast]), { value: e })),
  Zl = lambda((e) => Q(new ll(!1, [e.ast], [e.ast]), { value: e }));
...
const Ql = lambda((e) => Union([e, ql]));
function decodeTo(e, t) {
  return (n) =>
    Q(decodeTo$1(n.ast, e.ast, t ? Uc(t) : passthrough()), { from: n, to: e });
}
...
function link() {
  return (e, t) => new Link(e.ast, Uc(t));
}
const $l = Struct({ message: Jl, name: Ul(Jl), stack: Ul(Jl) }),
  eu = instanceOf(globalThis.Error, {
    typeConstructor: { _tag: `Error` },
    generation: { runtime: `Schema.Error`, Type: `globalThis.Error` },
    expected: `Error`,
    toCodecJson: () => link()($l, errorFromErrorJsonEncoded()),
...
const tu = new Z(
  ...
  nu = Union([
    $l.pipe(decodeTo(eu, errorFromErrorJsonEncoded())),
    Gl.pipe(
      decodeTo(
        Kl.annotate({
          toCodecJson: () => link()(Gl, tu),
...
const ru = globalThis.Symbol.for(`immer-draftable`);
...
function toCodecStringTree(e, t) {
  return Q(du(t?.keepDeclarations === !0 ? lu(e.ast) : su(e.ast)));
}
...
const iu = makeReorder(getStringTreePriority);
function serializerTree(e, t, n) {
  switch (e._tag) {
    case `Declaration`: {
      let r = e.annotations?.toCodecJson ?? e.annotations?.toCodec;
      if (isFunction(r)) {
        let n = r(Kc(e) ? e.typeParameters.map((e) => Q(t(Tl(e)))) : []),
          i = t(n.to);
        return replaceEncoding(
          e,
    ...
    case `Null`:
      return replaceEncoding(e, [au]);
    case `Boolean`:
      return replaceEncoding(e, [ou]);
    case `Unknown`:
    case `ObjectKeyword`:
      return replaceEncoding(e, [Il]);
    case `Enum`:
    case `Number`:
    case `Literal`:
    case `UniqueSymbol`:
...
const au = new Link(
  ...
  ou = new Link(
    new _l([new Literal$1(`true`), new Literal$1(`false`)], `anyOf`),
    new Z(
  ...
  su = toCodec((e) => {
    let t = serializerTree(e, su, (e) => replaceEncoding(e, [cu]));
    return t !== e && isOptional(e) ? Cl(t) : t;
  }),
  cu = new Link(
    il,
    new Z(
  ...
  lu = toCodec((e) => {
    let t = serializerTree(e, lu, identity);
    return t !== e && isOptional(e) ? Cl(t) : t;
  }),
  uu = `~effect/Schema/SERIALIZER_ENSURE_ARRAY`,
  du = toCodec((e) => {
    if (Qc(e) && e.annotations?.[uu]) return e;
    let t = onSerializerEnsureArray(e);
    if (Xc(t)) {
      let n = new _l(
        [t, decodeTo$1(sl, t, new Z(split(), passthrough$1()))],
        `anyOf`,
        { [uu]: !0 },
      );
...
const fu = fiberJoin,
  pu = fiberInterrupt,
  mu = fiberInterruptAll,
  hu = ua,
  gu = makeLatchUnsafe,
  _u = makeLatch,
  vu = Symbol.for(`effect/MutableList/Empty`),
  yu = __name(() => ({ head: void 0, tail: void 0, length: 0 }), `make`),
  ...
  xu = { _A: identity, _E: identity },
  Su = {
    "~effect/Queue": xu,
    "~effect/Queue/Enqueue": xu,
    "~effect/Queue/Dequeue": xu,
    ...Ae,
    toJSON() {
      return {
        _id: `effect/Queue`,
  ...
  offer = (e, t) =>
    R(() => {
      if (e.state._tag !== `Open`) return wu;
        ...
        switch (e.strategy) {
          ...
          case `suspend`:
            return e.capacity <= 0 && e.state.takers.size > 0
              ? (append(e.messages, t), releaseTakers(e), Tu)
              : offerRemainingSingle(e, t);
          case `sliding`:
            return (bu(e.messages), append(e.messages, t), Tu);
        }
      return (append(e.messages, t), scheduleReleaseTaker(e), Tu);
    }),
  offerUnsafe = (e, t) =>
    e.state._tag === `Open`
      ? e.messages.length >= e.capacity
        ? e.strategy === `sliding`
          ? (bu(e.messages), append(e.messages, t), !0)
  ...
  shutdown = (e) =>
    L(() => {
      ...
      if (
        (finalize(e, e.state._tag === `Open` ? Du : e.state.exit), t.size > 0)
      ) {
        for (let e of t)
          e._tag === `Single`
            ? e.resume(wu)
  ...
  offerRemainingSingle = (e, t) =>
    B((n) => {
      if (e.state._tag !== `Open`) return n(wu);
...
const Ou = `~effect/Channel`,
  ...
  fromTransform = (e) => {
    let t = Object.create(ku);
    return ((t.transform = (t, n) => js(e(t, n), (e) => q(hs(e)))), t);
  },
  transformPull = (e, t) =>
  ...
  fromTransformBracket = (e) =>
    fromTransform(
      xc(function* (t, n) {
        ...
        return nc(yield* nc(e(t, n, r), onCause), onCause);
      }),
    ),
  ...
  Nu = dual(2, (e, t) => Pu(e, (e) => q(t(e)))),
  Pu = dual(2, (e, t) => transformPull(e, (e) => q(Ko(e, (e) => X(t(e), G))))),
        ...
        if (n.unordered) {
          ...
          yield* s.pipe(
            X((r) => {
              if (n) return hs(n);
              let i = u(t(r, o++));
              return (d(i), i.addObserver(onExit), offer(e, fu(i)));
            }),
            lc({ disableYield: !0 }),
            js((t) => offer(e, ao(t)).pipe(Ss($(e, t)))),
            pc(a),
          );
        }
        return take(l);
      ...
      Ts(toTransform(e)(n, r), (e) => {
        let i,
          ...
          o = X(
            ...
            (e) => (
              (a ??= K(r)),
              Dc(toTransform(t(e))(n, a), (e) => ((i = s(e)), i))
            ),
          ),
          s = Ko((e) => {
            if (
  ...
  flatMapConcurrent = (e, t, n) => e.pipe(Mu(t), Hu(n)),
  flattenArray = (e) =>
    transformPull(e, (e) => {
      let t,
        n = 0;
  ...
  Bu = dual(2, (e, t) => zu(e, Ya, (e) => t(e))),
  Vu = dual(2, (e, t) => Bu(e, (e) => fail(t(e)))),
  Hu = dual(2, (e, { bufferSize: t = 16, concurrency: n, switch: r = !1 }) =>
    fromTransformBracket(
      xc(function* (i, a, o) {
        ...
        return (
          yield* ms(function* () {
            for (;;) {
              ...
              for (; u.size >= s; ) {
                let e = headUnsafe(u);
                (u.delete(e), u.size === 0 && (yield* l.open), yield* pu(e));
              }
              let r = yield* n.pipe(
                Cs(() => vs),
                X((e) => offer(d, e)),
        ...
        xc(function* (r, i, a) {
          ...
          let runSide = (e, t, n) =>
            toTransform(t)(r, n).pipe(
              ...
              nc((t) => Ss(Do(n, doneExitFromCause(t)), onExit(e, t))),
              pc(a),
            );
          return (
...
`,
  ...
  Ku = dual(2, (e, t) => Gu(e, (e) => t)),
  runWith = (e, t, n) =>
    J(() => {
      let r = So();
      return Ko(X(toTransform(e)(G(), r), t), n || q).pipe(rc((e) => Do(r, e)));
    }),
  qu = dual(2, (e, t) => runWith(e, (e) => lc(X(e, t), { disableYield: !0 }))),
  runHead = (e) =>
    J(() => {
      let t = none();
      return runWith(
  ...
  Yu = xc(
    function* (e) {
      let t = makeUnsafe(1),
        n = yield* Us(),
        r = pn(n, xo);
      return (yield* toTransform(e)(G(), r)).pipe(Ks(n), t.withPermits(1));
    },
    js((e) => q(hs(e))),
  ),
