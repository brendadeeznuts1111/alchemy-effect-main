...
const G = `~effect/FiberSet`,
  ...
  K = r(
    () =>
      P(
        U(() => makeUnsafe(new Set(), R())),
        (e) =>
          se(() => {
            let n = e.state;
            if (n._tag === `Closed`) return t;
            e.state = { _tag: `Closed` };
            let r = n.backing;
            return Se(r).pipe(ue(e.deferred));
          }),
      ),
    `make`,
  ),
      ...
      (e.state.backing.add(t),
        t.addObserver((r) => {
          e.state._tag !== `Closed` &&
            ...
            pe(r) &&
              (n?.propagateInterruption === !0 ? !Te(r.cause) : !A(r.cause)) &&
              M(e.deferred, r));
        }));
    },
  ),
  ...
  Z = new TextEncoder(),
  Q = new TextDecoder(),
  isCloseEvent = (e) => T(e, `~effect/socket/Socket/CloseEvent`),
  $ = `~effect/socket/Socket/SocketError`,
  isSocketError = (e) => T(e, $);
var SocketReadError = class extends x(`effect/socket/Socket/SocketReadError`)({
    _tag: B(`SocketReadError`),
    cause: u,
  }) {
    message = `An error occurred during Read`;
  },
  SocketWriteError = class extends x(`effect/socket/Socket/SocketWriteError`)({
    _tag: B(`SocketWriteError`),
    cause: u,
  }) {
    message = `An error occurred during Write`;
  },
  SocketOpenError = class extends x(`effect/socket/Socket/SocketOpenError`)({
    _tag: B(`SocketOpenError`),
    kind: ie([`Unknown`, `Timeout`]),
    cause: u,
  }) {
    get message() {
  ...
  SocketCloseError = class extends x(`effect/socket/Socket/SocketCloseError`)({
...
var SocketError = class extends ae($)(`SocketError`, {
  _tag: B(`SocketError`),
  reason: Ee,
}) {
  constructor(e) {
...
const toChannelMap = (t, r) =>
    le(
      b(function* (i, o) {
        let s = yield* te(),
          u = yield* I(o),
          f = yield* D(t.writer, u),
          p,
          m = 0,
          h = k({ while: () => m < p.length, body: () => f(p[m++]), step: N });
        return (
          yield* i.pipe(
            l((e) => (e.length === 1 ? f(e[0]) : ((p = e), (m = 0), h))),
            n({ disableYield: !0 }),
            a(Ce, (t) => e(s, t)),
            _(ye(u, be)),
            C(o),
...
var WebSocket = class extends V()(`~effect/socket/Socket/WebSocket`) {},
  WebSocketConstructor = class extends V()(
...
const makeWebSocket = (e, t) =>
    WebSocketConstructor.use((n) =>
      fromWebSocket(
        P(
          (typeof e == `string` ? W(e) : e).pipe(w((e) => n(e, t?.protocols))),
          (e) => U(() => e.close(1e3)),
        ),
        t,
      ),
  ...
  fromWebSocket = (e, n) =>
    g((r) => {
      let a,
        o = h(!1),
        s = r.context,
        c = n?.closeCodeIsError ?? defaultCloseCodeIsError,
        runRaw = (r, u) =>
          fe(
            b(function* (s) {
              let d = yield* K().pipe(D(s)),
                f = yield* D(e, s),
              ...
              return (
                ...
                yield* xe(
                  join(d),
                  SocketCloseError.filterClean((e) => !c(e)),
                  () => t,
                )
              );
            }),
